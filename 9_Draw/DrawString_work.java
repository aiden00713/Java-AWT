...
public class DrawString_work extends java.awt.Frame implements MouseListener, MouseMotionListener {
  String str = "";
  ...
  // 建構函式
  public DrawString_work() {
    super("Draw String work");
  ...
  public void paint (Graphics g) {
    ...
    // 設定Graphics物件之文字字型
    g.setFont(new Font("Console", Font.PLAIN, 16));
