...
public class KeyEventapp_b2 extends Frame implements Runnable {
    ...
    public static void main(String args[]) {
      KeyEventapp_b2 workStart=new KeyEventapp_b2();
    }
    
    public KeyEventapp_b2() {
        super("Key Event App");
        setSize(350,350);
		
		//sound = Applet.newAudioClip(getClass().getResource("/sound.wav"));
    ...
    public void processKeyEvent(KeyEvent e) {
        if(e.getID() == KeyEvent.KEY_PRESSED) {
			switch(e.getKeyCode()){
				...
				case KeyEvent.VK_P:  //PLAY voice
					sound.play();
					break;
					
				case KeyEvent.VK_S:  //STOP voice
					sound.stop();
					break;
			}
        }
